# app.py - Flask backend with clean startup
...
# Suppress Flask/Werkzeug development server messages
...
def login():
    ...
    user = next((u for u in users_db if u['username'] == data.get('username') and u['password'] == password), None)
    if user:
